...
-- ============================================================
-- FIX 3: AmethystTheme table is now actually passed to Rayfield via CustomTheme.
-- Rayfield accepts Theme = "Custom" + CustomTheme = <table> for user-defined palettes.
local Window
